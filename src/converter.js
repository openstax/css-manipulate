...
module.exports = (document, $, consol, {cssContents, cssSourcePath, htmlSourcePath, sourceMapPath, htmlOutputPath, options}) => {
  ...
  return allElementsDoneProcessingPromise.then(() => {
    return serializer(engine, htmlSourceLookup, htmlSourcePath, sourceMapPath, engine.getVanillaRules(), htmlOutputPath)
  })
}
