...
.option('diffmodeclassnames', {
  type: 'boolean',
  describe: 'Collapse the set of autogenerated class names for easier regression testing at the expense of providing more precise source mapping. It also strips any unused class names from the resulting HTML file so only the autogenerated ones remain'
})
.option('verbose', {
  type: 'boolean',
...
if (argv.diffmodeclassnames) {
  console.warn('WARNING: The autogenerated class names will not match their source. They will be collapsed so that diffing is easier.')
}
